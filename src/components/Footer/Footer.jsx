...
const Footer = () => {
  return (
    <footer class="bg-white text-gray-700 py-10">
      <Container>
        <div class="w-full mx-auto px-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <img src={logo}></img>
            ...
            <div class="mt-6 pt-4">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <span class="text-sm font-bold">Call +91 8585858585</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-span-1 lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div>
              <h3 class="font-semibold mb-2">Help & support</h3>
              <ul class="text-sm text-gray-600 space-y-1">
            ...
            <div>
              ...
              <ul class="text-sm text-gray-600 space-y-1">
                <li class="flex items-center gap-2">
                  <span class="inline-block w-4 h-4 bg-blue-500 rounded"></span>{" "}
                  Learner app
                </li>
                <li class="flex items-center gap-2">
                  <span class="inline-block w-4 h-4 bg-indigo-500 rounded"></span>{" "}
                  Educator app
                </li>
                <li class="flex items-center gap-2">
            ...
            <div class="sm:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10">
              <div>
                <h3 class="font-semibold mb-2">Popular goals</h3>
                <ul class="text-sm text-gray-600 space-y-1">
                  <li>IIT JEE</li>
                  <li>UPSC</li>
                  <li>SSC</li>
              ...
              <div>
                <h3 class="font-semibold mb-2">Studyshala Centre</h3>
                <ul class="text-sm text-gray-600 space-y-1">
                  <li>Kota IIT JEE</li>
                  <li>Kota NEET UG</li>
              ...
              <div>
                <h3 class="font-semibold mb-2">Study material</h3>
                <ul class="text-sm text-gray-600 space-y-1">
